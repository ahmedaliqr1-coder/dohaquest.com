...
if wp core is-installed --allow-root 2>/dev/null; then
    ...
    # Apply Kadence theme settings via PHP directly (more reliable than wp eval)
    echo "Applying Kadence theme settings via PHP..."
    php /var/www/html/apply-theme-settings.php 2>&1 || true
